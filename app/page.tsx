...
export default function Home() {
  return (
    <main className="min-h-screen bg-gradient-to-b to-gray-50/50 flex justify-center items-center from-white">
      {/*Background pattern */}
      <div className="absolute inset-0 -z-10 h-full bg-white bg-[linear-gradient(to_right, #e5e5e5_1px, transparent_1px),
      ...
      <section className="w-full px-4 py-8 mx-auto max-w-7xl sm:px-6 lg:px-8 flex flex-col items-center space-y-10 text-center">
        ...
        <header className="space-y-6">
          <h1 className="text-5xl font-bold tracking-tight sm:text-7xl bg-gradient-to-r from-gray-900 via-gray-800 to-gray-700
        ...
        px-8 py-3.5 text-base font-medium text-white bg-gradient-to-r from-gray-900 to-gray-800 rounded-full
        hover:from-gray-800 hover:to-gray-700 transition-all duration-200
        shadow-lg hover:shadow-xl hover:-translate-y-0.5 ">
          Get Started 
          <ArrowRight className="ml-2 h-5 w-5 transition-transform group-hover:translate-x-0.5" />
          <div className="absolute inset-0 rounded-full bg-gradient-to-r from-gray-900/20 to-gray-800/20 
        ...
        <SignedOut>
          ...
          text-white bg-gradient-to-r from-gray-900 to-gray-800 rounded-full hover:from-gray-800 hover:to-gray-700
          transition-all duration-200 shadow-lg hover:shadow-xl hover:-translate-y-0.5 cursor:pointer">
            Sign Up
            <ArrowRight className="ml-2 h-5 w-5 transition-transform group-hover:translate-x-0.5"/>
            <div className="absolute inset-0 rounded-full bg-gradient-to-r from-gray-900/20 to-gray-800/20 blur-xl
        ...
        {/* Features grid */}
        <div className="grid grid-cols-1 gap-8 md:grid-cols-3 md:gap-16 pt-8
        max-w-3xl mx-auto">
          {[
